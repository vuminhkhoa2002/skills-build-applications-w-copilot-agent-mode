...
# Django Settings configuration for OctoFit Tracker
# Database, apps, middleware, and security settings
...
AUTHENTICATION_BACKENDS = [
    ...
    'django_allauth.account.auth_backends.AuthenticationBackend',
]
